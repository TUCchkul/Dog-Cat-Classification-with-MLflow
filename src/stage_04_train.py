...
def main(config_path):
    ...
    train_ds=train_ds.prefetch(buffer_size=params["batch_size"])
    val_ds=val_ds.prefetch(buffer_size=params["batch_size"])
    ...
    logging.info(f"load the bse model from {path_to_model}")
